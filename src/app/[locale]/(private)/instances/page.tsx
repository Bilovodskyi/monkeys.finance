                ...
                <div className="h-full flex flex-col">
                    ...
                    <div className="flex-1 p-6 flex flex-col overflow-hidden">
                        ...
                        <div className="grid grid-cols-11 border border-zinc-800 backdrop-blur-md">
                            <div className="col-span-1 border-r border-zinc-800 px-4 py-3 text-tertiary">{t("tableHeaders.status")}</div>
                            <div className="col-span-3 border-r border-zinc-800 px-4 py-3 text-tertiary">{t("tableHeaders.name")}</div>
                            <div className="col-span-2 border-r border-zinc-800 px-4 py-3 text-tertiary">{t("tableHeaders.strategy")}</div>
                            <div className="col-span-2 border-r border-zinc-800 px-4 py-3 text-tertiary">{t("tableHeaders.instrument")}</div>
                            <div className="col-span-1 border-r border-zinc-800 px-4 py-3 text-tertiary">{t("tableHeaders.exchange")}</div>
                            <div className="col-span-1 border-r border-zinc-800 px-4 py-3 text-tertiary">{t("tableHeaders.createdAt")}</div>
                            <div className="col-span-1 border-r border-zinc-800 px-4 py-3 text-tertiary">{t("tableHeaders.actions")}</div>
                        </div>
                            ...
                            {instances.map((instance, index) => (
                                <CreateInstanceSheet key={index} apiKey={apiKey} instance={instance}>
                                    <div className="grid grid-cols-11 border border-zinc-800 border-t-0 hover:bg-neutral-900 transition-all duration-150 ease-in-out cursor-pointer">
                                        ...
                                        <div className="col-span-3 border-r border-zinc-800 px-4 py-3 flex items-center">{instance.name}</div>
                                        <div className="col-span-2 border-r border-zinc-800 px-4 py-3 flex items-center">{instance.strategy}</div>
                                        <div className="col-span-2 border-r border-zinc-800 px-4 py-3 flex items-center">{instance.instrument}</div>
                                        <div className="col-span-1 border-r border-zinc-800 px-4 py-3 flex items-center capitalize">{instance.exchange}</div>
                                        <div className="col-span-1 border-r border-zinc-800 px-4 py-3 flex items-center">{instance?.createdAt?.toLocaleDateString()}</div>
