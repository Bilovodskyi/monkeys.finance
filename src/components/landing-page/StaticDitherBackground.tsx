...
const StaticDitherBackground = () => {
    ...
    return (
        <section className="h-screen md:h-[60vh] px-4 md:px-24 relative mb-38 lg:mb-12 pt-8 md:pt-0">
            ...
            <div className="md:absolute md:bottom-24 md:left-1/2 md:-translate-x-1/2 flex flex-col md:flex-row items-center md:items-end justify-center gap-8 md:gap-24 mt-8 md:mt-0">
                <div className="flex flex-col items-center justify-center md:justify-start">
                    <h1 className="text-[60px] md:text-[80px] font-title">-8%</h1>
                    <h2 className="text-center text-md">
                        {t("stat1")}
                    </h2>
                </div>
                <div className="flex flex-col items-center justify-center">
                    <h1 className="text-[80px] md:text-[100px] font-title">81%</h1>
                    <h2 className="text-center text-xl">
                        {t("stat2")}
                    </h2>
                </div>
                <div className="flex flex-col items-center justify-center">
                    <h1 className="text-[60px] md:text-[80px] font-title">26%</h1>
                    <h2 className="text-center text-md">
                        {t("stat3")}
                    </h2>
                </div>
            </div>
            <div className="md:absolute md:-bottom-12 md:left-1/2 md:-translate-x-1/2 flex items-end justify-center gap-24 mt-8 md:mt-0">
