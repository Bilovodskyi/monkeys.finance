...
export function CreateInstanceSheet({ onClose, apiKey }: CreateInstanceSheetProps) {
    ...
    return (
        <SheetContent className="flex flex-col">
            <SheetHeader>
                <SheetTitle className="text-xl font-title">{translations("createNewInstance")}</SheetTitle>
